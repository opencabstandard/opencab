...
public class HOSContractTest {
    ...
    public void testParcel() {
        Clock1 clockWithDuration = new Clock1();
        ...
        Clock createdFromParcel = Clock.CREATOR.createFromParcel(parcel);
        Log.d(LOG_TAG, "clock with duration: " + clockWithDuration);
        Log.d(LOG_TAG, "clock with no duration: " + createdFromParcel);
        assertEquals(parcel, createdFromParcel);
    ...
    public static class Clock implements Parcelable {
        ...
        public String toString() {
            return "Clock{" +
                    ...
                    ", valueType=" + valueType +
                    ", important=" + important +
                    ", limitsDrivingRange=" + limitsDrivingRange +
                    '}';
        }
    ...
    public static class Clock1 implements Parcelable {
        private String label;
        private String value;
        private HOSContract.Clock.ValueType valueType;
        private boolean important;
