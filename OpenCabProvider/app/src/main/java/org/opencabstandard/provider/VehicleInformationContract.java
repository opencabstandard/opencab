...
public final class VehicleInformationContract {
    ...
    /**
     * Use this key to retrieve the VIN from the {@link Bundle} object that is returned
     * from the {@link VehicleInformationContract}.METHOD_GET_VEHICLE_INFORMATION method call. If the value is null,
     * an error occurred and you can then retrieve the error from the {@link Bundle} using the key
